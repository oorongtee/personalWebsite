    ...
    <footer class="contact-footer">
      <div class="footer-content">
        ...
        <div class="footer-section footer-left">
          <h4>🌟 Ray</h4>
          <p>Creating digital experiences that matter. I combine technical craft with product thinking to build solutions that users love and businesses can grow with.</p>
        </div>
        ...
        <div class="hero-main">
          <div class="photo-section">
            ...
            <div class="photo-buttons">
              <a href="#/works" class="photo-btn work-btn">📋 Explore My Projects</a>
              <a href="#/contact" class="photo-btn contact-btn">☕ Let's Connect</a>
            </div>
          </div>

          <div class="text-block">
            <h2>🌱 Creating Digital Experiences with Purpose & Empathy</h2>
            <p>
              I'm a product-minded creator who believes technology should serve people, not the other way around. With a unique blend of frontend engineering skills and product strategy thinking, I turn complex problems into intuitive solutions. I don't just build features—I craft experiences that users actually love and businesses can grow with.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="cards-section">
      <div class="cards-grid">
        <div class="card">
          ...
          <h3 class="card-title">Product Thinking</h3>
          <p class="card-description">I approach every project like a product—understanding user needs, defining success metrics, and iterating based on real feedback. Code is just the tool; solving human problems is the goal.</p>
        </div>

        <div class="card">
          <span class="card-number">🎨</span>
          <h3 class="card-title">Craft & Code</h3>
          <p class="card-description">From concept sketches to production-ready code, I bridge the gap between design and development. I create prototypes that feel real and interfaces that work beautifully across all devices.</p>
        </div>

        <div class="card">
          <span class="card-number">
🤝</span>
          <h3 class="card-title">Empathy-Driven</h3>
          <p class="card-description">Great products start with understanding. I listen deeply to users and stakeholders, translating their needs into actionable solutions that create real value.</p>
        </div>

        <div class="card">
          <span class="card-number">⚡</span>
          <h3 class="card-title">Ship & Learn</h3>
          <p class="card-description">I believe in shipping early, measuring impact, and learning fast. Every feature is an experiment, every user interaction teaches us something new about what works.</p>
        </div>
      </div>
    </section>
    ...
    <section class="interests-section">
      <div class="interests-content">
        <p class="interests-text">
          🏔️ Beyond screens and code, I find balance in nature's rhythm. Ocean waves and mountain trails remind me that the best solutions often come from stepping back, breathing deeply, and seeing the bigger picture. These moments of presence shape how I approach challenges—with patience, perspective, and curiosity.
        </p>
  ...
  about: `
    <main class="page-content about-page">
      <div class="hero-content">
          ...
          <div class="expertise-list">
            <div class="expertise-item">
              <div class="expertise-content">
                ...
                <p class="expertise-description">
                  I write code that people actually want to use. Beyond clean syntax and performance optimization, I focus on creating digital experiences that feel intuitive and delightful. My technical foundation spans modern JavaScript, React, Vue.js, and emerging web technologies—but what matters most is how I use these tools to solve real problems for real users.
                </p>
              </div>
            ...
            <div class="expertise-item">
              <div class="expertise-content">
                ...
                <p class="expertise-description">
                  I think like a product person because I understand that great technology means nothing without great outcomes. I help teams define what success looks like, prioritize features that matter, and build solutions that users love and businesses can grow with. My background in both code and strategy lets me bridge the gap between "what's possible" and "what's valuable."
                </p>
              </div>
            ...
            <div class="expertise-item">
              <div class="expertise-content">
                ...
                <p class="expertise-description">
                  Good design is invisible—it just works. I approach design through the lens of user empathy and business goals, creating interfaces that feel natural and purposeful. Whether I'm prototyping in Figma or writing CSS, I'm always thinking about how design decisions impact the human experience on the other side of the screen.
                </p>
              </div>
        ...
        <!-- 🌱 價值觀卡片區塊 -->
        <section class="cards-section">
          <div class="cards-grid about-values-cards">
            <div class="card">
              <span class="card-number">🌍</span>
              <h3 class="card-title">Human-Centered</h3>
              <p class="card-description">Technology should serve people, not the other way around. I believe in building experiences that enhance human capability and connection.</p>
            </div>
            <div class="card">
              <span class="card-number">🔮</span>
              <h3 class="card-title">Continuous Learning</h3>
              <p class="card-description">The best solutions emerge from curiosity and experimentation. I stay curious about new technologies while focusing on timeless principles.</p>
            </div>
          </div>
        </section>
        ...
        <section class="work-experience-section">
          ...
          <div class="timeline">
            ...
            <div class="timeline-item">
              <div class="timeline-date">
                <span class="date-range">Oct 2023 - Nov 2025</span>
                <div class="timeline-dot green"></div>
              </div>
              <div class="timeline-content">
                <h3>🌱 Self-Learning Journey</h3>
                <div class="company-info">
                  <span class="company-name">Frontend Development & Online Courses</span>
                </div>
                <div class="job-description">
                  <p>Started self-learning frontend web development and pursued comprehensive online certifications to build a solid foundation in product management and technology.</p>
                  <div class="certifications">
                    <h4>📚 Relevant Certifications: Coursera</h4>
                    <ul>
                      <li>• Google Project Management</li>
                      <li>• IBM Product Management</li>
                      <li>• Google UX Design</li>
                      <li>• Rutgers Supply Chain Management</li>
                      <li>• IBM Introduction to Cloud Computing</li>
                    </ul>
                  </div>
                </div>
              </div>
  ...
  works: `
    <main class="page-content works-page">
      <div class="hero-content">
        <h1>🚀 My Works</h1>
        <p class="page-subtitle">Digital experiences I've crafted with purpose and empathy</p>
        
        <!-- 🌱 介紹卡片區塊 -->
        <section class="cards-section">
          <div class="cards-grid works-intro-cards">
            <div class="card">
              <span class="card-number">🏠</span>
              <h3 class="card-title">Web Applications</h3>
              <p class="card-description">Full-stack applications built with modern frameworks, focusing on user experience and performance optimization.</p>
            </div>
            <div class="card">
              <span class="card-number">📱</span>
              <h3 class="card-title">Mobile-First Design</h3>
              <p class="card-description">Responsive interfaces that work beautifully across all devices, with accessibility and usability at the core.</p>
            </div>
          </div>
        </section>
  ...
  notes: `
    <main class="page-content notes-page">
      <div class="hero-content">
        <h1>📝 My Notes</h1>
        <p class="page-subtitle">Insights from building products that matter—development tips, user experience thoughts, and lessons learned from real projects</p>
        
        <!-- 🌱 介紹卡片區塊 -->
        <section class="cards-section">
          <div class="cards-grid notes-intro-cards">
            <div class="card">
              <span class="card-number">📚</span>
              <h3 class="card-title">Development Insights</h3>
              <p class="card-description">Real-world coding solutions, best practices, and lessons learned from building production applications.</p>
            </div>
            <div class="card">
              <span class="card-number">🌍</span>
              <h3 class="card-title">Product Thinking</h3>
              <p class="card-description">Thoughts on user experience, product strategy, and how to build technology that serves people better.</p>
            </div>
          </div>
        </section>
  ...
  contact: `
    <main class="page-content contact-page">
      <div class="hero-content">
        ...
        <p class="page-subtitle">Ready to create something meaningful together? I'd love to hear about your vision and explore how we can bring it to life.</p>

        <!-- 🌱 合作方式卡片 -->
        <section class="cards-section">
          <div class="cards-grid contact-intro-cards">
            <div class="card">
              <span class="card-number">💭</span>
              <h3 class="card-title">Discovery Call</h3>
              <p class="card-description">Let's start with understanding your users' needs and business goals. I offer free 30-minute discovery calls to explore how we can work together.</p>
            </div>
            <div class="card">
              <span class="card-number">🤝</span>
              <h3 class="card-title">Collaborative Process</h3>
              <p class="card-description">I believe the best products come from close collaboration. We'll work together throughout the process, iterating based on real feedback and data.</p>
            </div>
          </div>
        </section>
